                    ...
                    <div class="footer-single-widget">
                        <div class="widget-title">
                            <div class="footer-logo mb-30">
                                <a href="index.html">
                                    <img src="{{BASE_URL . "public"}}/assets/img/logo/logo-sinrato.png" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="widget-body">
                            ...
                            <div class="payment-method">
                                <h4>payment</h4>
                                <img src="{{BASE_URL . "public"}}/assets/img/payment/payment.png" alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="product-large-slider mb-20">
                                ...
                                <div class="pro-large-img">
                                    <img src="{{BASE_URL . "public"}}/assets/img/product/product-5.jpg" alt=""/>
                                </div>
                                <div class="pro-large-img">
                            ...
                            <div class="pro-nav">
                                <div class="pro-nav-thumb"><img src="{{BASE_URL . "public"}}/assets/img/product/product-4.jpg" alt="" /></div>
                                <div class="pro-nav-thumb"><img src="{{BASE_URL . "public"}}/assets/img/product/product-5.jpg" alt="" /></div>
                                <div class="pro-nav-thumb"><img src="{{BASE_URL . "public"}}/assets/img/product/product-6.jpg" alt="" /></div>
                                <div class="pro-nav-thumb"><img src="{{BASE_URL . "public"}}/assets/img/product/product-7.jpg" alt="" /></div>
                                <div class="pro-nav-thumb"><img src="{{BASE_URL . "public"}}/assets/img/product/product-8.jpg" alt="" /></div>
                                <div class="pro-nav-thumb"><img src="{{BASE_URL . "public"}}/assets/img/product/product-9.jpg" alt="" /></div>
                            </div>
                        </div>
                        <div class="col-lg-7">
