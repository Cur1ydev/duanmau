                    ...
                    <div class="box box-right">
                        <ul>
                            ...
                            <li class="settings">
                                ...
                                <ul class="box-dropdown ha-dropdown">
                                    <li><a href="login.html"><img src="{{BASE_URL . "public"}}/assets/img/icon/en.png" alt=""> English</a></li>
                                    <li><a href="login.html"><img src="{{BASE_URL . "public"}}/assets/img/icon/ge.png" alt=""> Germany</a></li>
                                </ul>
                            </li>
                            <li class="currency">
        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-lg-2 col-md-4 col-sm-4 col-12">
                    <div class="logo">
                        <a href="index.html"><img src="{{BASE_URL . "public"}}/assets/img/logo/logo-sinrato.png" alt="brand-logo"></a>
                    </div>
                </div>
...
{{--                                    </li>--}}
                                    ...
                                    <li><a href="{{"/$category->category_slug"}}">{{$category->category_name}}</a></li>
                                    @endforeach
