    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header d-block text-center">
                <h5 class="modal-title w-100" id="exampleModalLabel22">Xoá ?</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-animation btn-md fw-bold" data-bs-target="#exampleModalToggle2"
                        data-bs-toggle="modal" data-bs-dismiss="modal">Có</button>
            </div>
        </div>
    </div>
</div>
...
<!-- feather icon js -->
<script src="{{BASE_URL . "public/admin"}}/assets/js/icons/feather-icon/feather.min.js"></script>
<script src="{{BASE_URL . "public/admin"}}/assets/js/icons/feather-icon/feather-icon.js"></script>

<!-- scrollbar simplebar js -->
<script src="{{BASE_URL . "public/admin"}}/assets/js/scrollbar/simplebar.js"></script>
<script src="{{BASE_URL . "public/admin"}}/assets/js/scrollbar/custom.js"></script>

<!-- Sidebar jquery -->
<script src="{{BASE_URL . "public/admin"}}/assets/js/config.js"></script>

<!-- tooltip init js -->
<script src="{{BASE_URL . "public/admin"}}/assets/js/tooltip-init.js"></script>

<!-- Plugins JS -->
<script src="{{BASE_URL . "public/admin"}}/assets/js/sidebar-menu.js"></script>
<script src="{{BASE_URL . "public/admin"}}/assets/js/notify/bootstrap-notify.min.js"></script>
...
<!-- slick slider js -->
<script src="{{BASE_URL . "public/admin"}}/assets/js/slick.min.js"></script>
<script src="{{BASE_URL . "public/admin"}}/assets/js/custom-slick.js"></script>

<!-- customizer js -->
<script src="{{BASE_URL . "public/admin"}}/assets/js/customizer.js"></script>

<!-- ratio js -->
<script src="{{BASE_URL . "public/admin"}}/assets/js/ratio.js"></script>

<!-- sidebar effect -->
<script src="{{BASE_URL . "public/admin"}}/assets/js/sidebareffect.js"></script>
